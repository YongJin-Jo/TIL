...
export const BasicSyntax = () => {
  return (
    <Column as="header">
      ...
      <Column>
        <Input small={'small'} placeholder="Small" />
...
const Box = styled.div`
  background-color: ${(props: IPorps) => props.bgColor};
  width: 100px;
  height: 100px;
`;
...
const Input = styled.input.attrs((props: IPorps) => ({
  type: 'text',
  ...
  display: block;
  margin: 0 0 1em;
  padding: ${(props: IPorps) => props.padding};
